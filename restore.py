...
def x2():
    data = xlrd.open_workbook('/Users/HZzone/Desktop/male.xlsx')
    table = data.sheets()[0]
...
'15.00-15.99': 4}
    val = {'25.00-25.99': 0,
            ...
            '15.00-15.99': 0}
    print c
    for root, dirs, files in os.walk("/Volumes/Hzzone/processed/male"):
        for dicom_file in files:
            ...
            for i in c:
                if abs(age-i) <= 0.0000000001:
                    print (age-i)
                    try:
                        shutil.move(path, "/Volumes/Hzzone/processed/male/test")
                    except:
                        continue
