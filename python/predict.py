...
def predict_dir(caffemodel, deploy, source_list, IMAGE_SIZE=227, LAYER_NAME="my-fc8", mode=True, BORDER_AGE=18):
    ...
    net.blobs['data'].reshape(len(file_list)/2, 3, IMAGE_SIZE, IMAGE_SIZE)
    net.blobs['data'].data[...] = images[:len(file_list)/2]
    output1 = net.forward()
    net.blobs['data'].reshape(len(file_list) - len(file_list)/2, 3, IMAGE_SIZE, IMAGE_SIZE)
    net.blobs['data'].data[...] = images[len(file_list)/2:]
    output2 = net.forward()
    output = dict(output1.items()+output2.items())
...
# #####
predict_by_caffemodel_dir(caffemodel_source="/home/hzzone/1tb/bone-age-model/bysex/female/resnet", test_deploy="/home/hzzone/Bone-Age-Assessment/train/female/ResNet/resnet_deploy.prototxt", test_data_source_list=["/home/hzzone/Bone-Age-Data/test1/female", "/home/hzzone/Bone-Age-Data/test2/female"], LOG_FILE="resnet_female_predict.log", IMAGE_SIZE=224, LAYER_NAME="my-fc1000")
predict_by_caffemodel_dir(caffemodel_source="/home/hzzone/1tb/bone-age-model/bysex/male/resnet", test_deploy="/home/hzzone/Bone-Age-Assessment/train/male/ResNet/resnet_deploy.prototxt", test_data_source_list=["/home/hzzone/Bone-Age-Data/test1/male", "/home/hzzone/Bone-Age-Data/test2/male"], LOG_FILE="resnet_male_predict.log", IMAGE_SIZE=224, LAYER_NAME="my-fc1000")
predict_by_caffemodel_dir(caffemodel_source="/home/hzzone/1tb/bone-age-model/all/resnet", test_deploy="/home/hzzone/Bone-Age-Assessment/train/all/ResNet/resnet_deploy.prototxt", test_data_source_list=["/home/hzzone/Bone-Age-Data/test1", "/home/hzzone/Bone-Age-Data/test2"], LOG_FILE="resnet_all_predict.log", IMAGE_SIZE=224, LAYER_NAME="my-fc1000")
